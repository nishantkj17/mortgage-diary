(function(){
  ...
  let currentTheme = localStorage.getItem('propfolio-theme') || 'system';
  ...
  function themeIcon(t) {
    ...
    if (t === 'light')  return `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>`;
    return `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="5" y="2" width="14" height="20" rx="2"/><circle cx="12" cy="18" r="1" fill="currentColor" stroke="none"/></svg>`;
  }
  ...
  function applyTheme(t) {
    ...
    const label = t === 'light' ? 'Light mode' : t === 'dark' ? 'Dark mode' : 'System theme';
    qsa('.theme-toggle-btn').forEach(btn => { btn.innerHTML = themeIcon(t); btn.title = label; });
  }
